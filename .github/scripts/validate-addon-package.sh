...
# 2) Find the TOC file (SpectrumFederation.toc)
...
# 3) Validate TOC name vs folder name (CurseForge / WoW requirement)
...
echo "[validate-addon-package] Interface value '$interface_value' looks OK."
...
echo "[validate-addon-package] Zip structure looks good for WowUp and CurseForge."
