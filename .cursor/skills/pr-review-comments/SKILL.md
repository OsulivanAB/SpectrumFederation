...
- Do not weaken CI, skip validation, or mark in-game testing complete in the PR template. In-game QA is human-owned. Validate PR Description may fail until a human checks that box; do not check it to make CI pass (see `.cursor/rules/pr-template.mdc`).
