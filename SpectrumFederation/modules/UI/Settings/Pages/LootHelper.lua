...
local function BuildLootHelperDefinition(panel, sectionIds)
	...
	local function BuildLinkedCharacterItems()
		...
		local groups = Identity.LinkedGroups(logs)
		local items = {}
