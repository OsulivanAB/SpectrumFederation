		...
		session = {
			...
			items = {
				...
				{ type = "text", text = "Raid Checks..." },
					...
					{ type = "titleDivider", text = "Whisper Templates", tooltip = "Customize the whisper that is sent by modifying the templates below.", adminOnly = true, visible = function() return ShouldShowWhisperTemplates() end },
