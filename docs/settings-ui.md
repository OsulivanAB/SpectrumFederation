...
Profile admins can add profile members as admins, remove admins other than the owner, and manage **Linked Characters**.

The owner cannot be removed from the admin list through this page. Only the effective owner may link or unlink characters that belong to the canonical owner's identity.
