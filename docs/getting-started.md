...
- In Reward Pot mode, the Points column is hidden, those buttons adjust the Attendance balance by one (not the Att.% column), and the current pot is shown above the list.
