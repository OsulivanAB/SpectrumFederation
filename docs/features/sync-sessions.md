...
Linked Character identity, admin implication, item-aware BiS, and progression are derived from that same history. All clients in a session must speak protocol version 4; protocol 3 and older clients are incompatible.
