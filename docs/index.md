...
- **RC Loot Council Capture** — a temporary nested child addon that records RC Loot Council communications while a Spectrum Loot Helper session is active. Open it from **Loot Helper → RC Loot Council**.
