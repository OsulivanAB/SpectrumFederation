...
- **Raid Check** — addon-owned current-Retail enchant and gem checks, an optional profile minimum item level, optional whispers, and loot-point or Attendance awards for prepared profile members. The equipment audit lives under **Raid Equipment**.
